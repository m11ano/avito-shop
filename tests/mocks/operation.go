...
func (_m *Operation) GetBalanceByAccountID(ctx context.Context, accountID uuid.UUID) (int64, bool, error) {
...
func (_m *Operation) SaveOperation(ctx context.Context, operation *domain.Operation) (int64, error) {
